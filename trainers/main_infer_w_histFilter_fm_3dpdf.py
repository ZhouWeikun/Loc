...
from util_analyze_pred3d import compute_top_k_accuracy,print_accuracy_results,compute_2d_plane_accuracy,compute_rotation_accuracy_at_gt_position
if __name__ == '__main__':
    ...
    from util_analyze_pred3d import compute_2d_neighbors_recall
