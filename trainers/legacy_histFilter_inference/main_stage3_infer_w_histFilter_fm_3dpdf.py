...
if __name__ == '__main__':
    ...
    for i in range(diff_rot_rad.shape[0]):
        ...
        # histfilter.update(pred_pdf_3d_hist[i+1:i+2],alphersion0:the best for Integral Inference Scheme
        #         # histfilter.predict(move_rot=diff_rot_rad[i],noise_std_rot=30/180*torch.pi,direction_aware=False,noise_std_xy=0.65,xy_k_size=5)
        #         # histfilter.update(pred_pdf_3d_hist[i+1:i+2],alpa=0.25)
        # version1:
    ...
    from trainers.leggacy_stage.util_stage3_analyze_pred3d import compute_2d_neighbors_recall
