...
from draw_gt_arrow_on_stage3_preds import (
    DEFAULT_GT_COLOR,
    DEFAULT_PRED_COLOR,
    DEFAULT_STAGES,
    _parse_color,
...
DEFAULT_RESULT_ROOTS = (
    Path("/home/data/zwk/pyproj_neuloc_v0/gen_fm_exps/ckpts/stage2_visloc03_interval82_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW19_mlpH1024B1_PN1cubie_1/res_epoch999"),
    Path("/home/data/zwk/pyproj_neuloc_v0/gen_fm_exps/ckpts/stage2_visloc04_interval82_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW19_mlpH1024B2_PN1cubie/res_epoch999"),
    Path("/home/data/zwk/pyproj_neuloc_v0/gen_fm_exps/ckpts/stage2_visloc03_segment82_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW19_mlpH1024B2_PN1cubie/res_epoch999"),
    Path("/home/data/zwk/pyproj_neuloc_v0/gen_fm_exps/ckpts/stage2_visloc04_segment82_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW19_mlpH1024B2_PN1cubie/res_epoch999"),
    Path("/home/data/zwk/pyproj_neuloc_v0/gen_fm_exps/ckpts/stage2_zuchwil_interval91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_mlpH1024B2_PN1cubie/res_epoch999"),
    Path("/home/data/zwk/pyproj_neuloc_v0/gen_fm_exps/ckpts/stage2_zuchwil_segment91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_mlpH1024B2_PN1cubie/res_epoch999"),
    Path("/home/data/zwk/pyproj_neuloc_v0/gen_fm_exps/ckpts/stage2_zurich_interval91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_mlpH1024B2_PN1cubie/res_epoch999"),
    Path("/home/data/zwk/pyproj_neuloc_v0/gen_fm_exps/ckpts/stage2_zurich_segment91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_mlpH1024B2_PN1cubie_1/res_epoch990"),
)
