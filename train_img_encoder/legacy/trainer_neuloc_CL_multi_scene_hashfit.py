...
class Trainer(object):
    ...
    def test_xy_rot_fm_INGP_wUAV(self,overlap=0.5,opt=False):
        self._test_ready()
...
if __name__ == '__main__':
    ...
    trainer = Trainer()
    # trainer.train()
    trainer.test_xy_rot_fm_INGP_wUAV(overlap=0.)
    # trainer.test_xy_scale_fm_INGP_wUAV(overlap=0.,use_multiscale=True,n_scales=3)
