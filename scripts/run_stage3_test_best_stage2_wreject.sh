...
# test infonce:
#declare -a RUN_SPECS=(
#  "$WINGTRA_YAML|zurich|$REPO_ROOT/gen_fm_exps/ckpts/stage2__interval91_wRejectSampling_infonceloss_dinov2_adF4_salad_codebookW18_mlpH1024B2_PN1cubie/epoch999.pth|$REPO_ROOT/gen_fm_exps/ckpts/stage2_zuchwil_interval91_wRejectSampling_infonceloss_dinov2_adF4_salad_codebookW18_mlpH1024B2_PN1cubie/opts.yaml|per_scene"
#    "$WINGTRA_YAML|zurich|$REPO_ROOT/gen_fm_exps/ckpts/stage2_visloc03_interval82_wRejectSampling_infonceloss_dinov2_adF4_salad_codebookW19_mlpH1024B2_PN1cubie/epoch999.pth|$REPO_ROOT/gen_fm_exps/ckpts/stage2_visloc03_interval82_wRejectSampling_infonceloss_dinov2_adF4_salad_codebookW19_mlpH1024B2_PN1cubie/opts.yaml|per_scene"
#)
# test no PosePE
declare -a RUN_SPECS=(
  "$WINGTRA_YAML|zurich|$REPO_ROOT/gen_fm_exps/ckpts/stage2_zurich_interval91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_mlpH1024B2_noPoseCond/epoch999.pth|$REPO_ROOT/gen_fm_exps/ckpts/stage2_zurich_interval91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_mlpH1024B2_noPoseCond/opts.yaml|per_scene"
#  "$WINGTRA_YAML|zurich|$REPO_ROOT/gen_fm_exps/ckpts/stage2_zurich_interval91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_plainMLPH1024L2_noPoseCond/epoch999.pth|$REPO_ROOT/gen_fm_exps/ckpts/stage2_zurich_interval91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_plainMLPH1024L2_noPoseCond/opts.yaml|per_scene"
)
  # test no plainMLP_PosePE_msloss
#declare -a RUN_SPECS=(
#  "$WINGTRA_YAML|zurich|$REPO_ROOT/gen_fm_exps/ckpts/stage2_zurich_interval91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_plainMLPH1024L2_noPoseCond_1/epoch999.pth|$REPO_ROOT/gen_fm_exps/ckpts/stage2_zurich_interval91_wRejectSampling_tripleLoss_singleEdge_hardest_fmMask_dinov2_adF4_codebookW18_plainMLPH1024L2_noPoseCond_1/opts.yaml|per_scene"
#)
